...
(defcustom my-doom-one-brighter-comments nil
...
(def-doom-theme my-doom-one
 ...
 ;; and `doom-blend' helper functions.
   ...
   (modeline-bg              (if my-doom-one-brighter-modeline
                                 (doom-darken blue 0.45)
                               (doom-darken bg-alt 0.1)))
   (modeline-bg-alt          (if my-doom-one-brighter-modeline
  ...
  (((line-number &override) :foreground base4)
   ...
   ((font-lock-comment-face &override)
    :background (if my-doom-one-brighter-comments (doom-lighten bg 0.05)))
   (mode-line
   ...
   (mode-line-emphasis :foreground (if my-doom-one-brighter-modeline base8 highlight))
   ...
   ;;;; doom-modeline
   (doom-modeline-bar :background (if my-doom-one-brighter-modeline modeline-bg highlight))
