...
- [[#user-interface-ui][User interface (UI)]]
  ...
  - [[#paddingboardermargins][Padding/boarder/margins]]
  - [[#window-dividers][Window dividers]]
  - [[#scroll-bar-yascroll][Scroll bar (~yascroll~)]]
  - [[#column-indicator][Column indicator]]
  - [[#emacs-terminal-cursor-changer][~emacs-terminal-cursor-changer~]]
  - [[#disable-spellcheck-spell-fu-not-flyspell][Disable spellcheck (~spell-fu~ (not ~flyspell~))]]
- [[#dashboard][Dashboard]]
- [[#modeline][Modeline]]
- [[#completion-company][Completion (company)]]
  - [[#fixme-main][FIXME main]]
  - [[#fixme-mycompany-show-doc-buffer][FIXME ~my/company-show-doc-buffer~]]
- [[#org][Org]]
  - [[#fixme-general-inc-ui][FIXME General (inc. UI)]]
  - [[#org-modern][Org Modern]]
  - [[#headings-what-about-it][Headings what about it]]
  - [[#todos][Todo's]]
  - [[#tags][Tags]]
  - [[#tables][Tables]]
...
- [[#calendar][Calendar]]
- [[#latex][Latex]]
  - [[#latex-fragments-1][Latex Fragments]]
- [[#packages-2][Packages]]
  - [[#pdf-tools][Pdf (tools)]]
  - [[#novel][Nov.el]]
...
- [[#my-keybindings][My Keybindings]]
  - [[#visual-fill-column-better-zen-mode][Visual Fill Column (better zen mode)]]
...
* My Keybindings
** Visual Fill Column (better zen mode)
#+begin_src elisp
